"""
    https://www.hackerrank.com/challenges/python-eval/problem
        HACKERRANK
    Practice > Python > Build-ins > Python Evaluation

------------------Python Evaluation---------------------
The eval() expression is a very powerful built-in function 
of Python. It helps in evaluating an expression. The expression 
can be a Python statement, or a code object.
